      ...
      <div className="relative z-10 flex w-full flex-col items-center justify-center gap-2 text-base">
        <div className="relative flex w-full flex-row justify-center gap-2 lg:w-4/5">
          <div
            ...
            className={` bg-neutral-50  dark:bg-surface-700 relative w-full max-w-[48rem] p-1 backdrop-blur-lg duration-100 border border-gray-300 rounded-t-xl  dark:border-[#404040] data-[istemporary-chat='true']:bg-surface-200 data-[istemporary-chat='true']:dark:bg-surface-900`}>
            <div
