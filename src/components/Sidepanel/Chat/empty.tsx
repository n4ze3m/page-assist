...
export const EmptySidePanel = () => {
  ...
  if (!checkOllamaStatus) {
    return (
      <div className="mx-auto sm:max-w-md px-4 mt-10">
        <div className="rounded-lg justify-center items-center flex flex-col border dark:border-gray-700 p-8 bg-surface-50 dark:bg-surface-700 shadow-sm">
  ...
  return (
    <div className="mx-auto sm:max-w-lg px-4 mt-10">
      <div className="rounded-lg  justify-center items-center flex flex-col border border-gray-300 dark:border-gray-700 p-8 bg-surface-50 dark:bg-surface-700 shadow-sm">
