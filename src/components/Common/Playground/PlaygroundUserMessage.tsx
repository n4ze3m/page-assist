  ...
  return (
    <div
      ...
      {editMode && (
        <div
          dir="auto"
          className={`message-bubble bg-surface-50 dark:bg-surface-800 rounded-3xl prose dark:prose-invert break-words text-primary min-h-7 prose-p:opacity-95 prose-strong:opacity-100 bg-foreground border border-input-border max-w-[100%] sm:max-w-[90%] px-4 py-2.5 rounded-br-lg dark:border-[#2a2a2a] ${
            props.message_type && !editMode ? "italic" : ""
          }`}>
