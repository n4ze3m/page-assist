...
export const DocumentFile: React.FC<DocumentFileProps> = ({ document }) => {
  return (
    <button
      className="relative group p-1.5 w-80 flex items-center gap-1 bg-white dark:bg-surface-900 border border-gray-200 dark:border-white/5 rounded-2xl text-left"
      type="button">
