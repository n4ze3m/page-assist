...
vi.mock('@tanstack/react-query', async () => {
  return {
    ...
    useInfiniteQuery: () => ({ data: { pages: [{ groups: [], hasMore: false, totalCount: 0 }] }, status: 'success', fetchNextPage: vi.fn(), hasNextPage: false, isFetchingNextPage: false, isLoading: false })
  }
})
