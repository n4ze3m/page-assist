      ...
      <div className="px-2 sm:px-0">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div className="flex-shrink-0">
              <button
                ...
                className="inline-flex items-center justify-center rounded-md border border-transparent bg-surface-900 px-3 py-2 text-sm font-medium leading-4 text-white shadow-sm hover:bg-surface-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:bg-surface-50 dark:text-gray-800 dark:hover:bg-surface-100 dark:focus:ring-gray-500 dark:focus:ring-offset-gray-100 disabled:opacity-50 w-full sm:w-auto">
                {t("addBtn")}
              </button>
            </div>
          </div>
        ...
        <Modal
          ...
          <Form
              ...
              {(fields, { add, remove }) => (
                <div className="flex flex-col">
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <button
                      type="button"
                      className="dark:bg-surface-50 dark:text-black text-white bg-surface-900 px-2 py-1 text-xs rounded-md"
                      onClick={() => {
                        add()
                      }}>
                      {t(
            ...
            {provider === "lmstudio" && (
              <div className="text-xs text-gray-600 dark:text-gray-400 mb-4 p-2 bg-surface-50 dark:bg-surface-800 rounded-md">
                {t("modal.tipLMStudio")}
              </div>
            )}
            <button
