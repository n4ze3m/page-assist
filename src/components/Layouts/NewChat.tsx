    ...
    <div className="flex items-center justify-between">
      ...
      <Tooltip title={t("temporaryChat")}>
        <button
          ...
          <BsIncognito className="size-4 sm:size-5 text-gray-500 dark:text-gray-400 data-[istemporary-chat='true']:text-white data-[istemporary-chat='true']:dark:text-purple-200" />
        </button>
      </Tooltip>
      {/* </Dropdown> */}
    </div>
