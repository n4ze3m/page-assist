...
export const Header: React.FC<Props> = ({
  ...
  return (
    <div
      ...
      className={`absolute top-0 z-10 flex h-14 w-full flex-row items-center justify-center p-3 overflow-x-auto lg:overflow-x-visible bg-surface-50 border-b  dark:bg-surface-900 dark:border-gray-600 data-[istemporary-chat='true']:bg-gray-200 data-[istemporary-chat='true']:dark:bg-surface-900`}>
