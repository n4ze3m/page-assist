...
| ---------------------- | -------- | ----------- | ------- | ------------------------------- |
| unify-browser.md       | High     | 1-2h        | Pending | Cross-browser merge             |
| modularize-services.md | Medium   | 2h          | Pending | Services subdirs + interfaces   |
| enhance-routes-ui.md   | High     | 2h          | Pending | Settings grouping + UI wrappers |
